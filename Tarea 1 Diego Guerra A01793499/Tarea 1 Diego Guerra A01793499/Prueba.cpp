...
# endif
    ...
    std::cout << "Generando Arrays aleatorios y realizando una suma en Paralelo!\n";
    float a[N], b[N], c[N];
    int i;
    ...
    schedule(static, pedazos)
        ...
        std::cout << "Imprimiendo los primeros " << mostrar << " valores del arreglo c para comprobar la suma: " << std::endl;
        imprimeArreglo(c);
}
